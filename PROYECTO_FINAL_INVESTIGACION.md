...
### Criterios de Suspensión de Sesión
...
## Fases del Diseño de Criterio Cambiante
...
**Criterio de estabilidad**: Dado que es una sola sesión, se asume como punto de referencia basal. Si se observa variabilidad extrema en mediciones múltiples dentro de la sesión, se pueden tomar promedios.
...
### Fase 1: Intervención con Criterio 7 Minutos (b1)
...
### Fase 2: Intervención con Criterio 10 Minutos (b2)
...
### Fase 3: Intervención con Criterio 12 Minutos (b3)
...
### Fase 4: Intervención con Criterio 15 Minutos (b4)
...
### ¿cómo Se Espera Que Funcione el Reforzamiento?
...
### ¿cómo Se Espera Que Funcione la Psicohigiene?
...
## Criterios de Decisión para Cambio de Fase
...
### Criterios para Mantener el Mismo Criterio (sesión Adicional)
...
3. El participante mostró mejoría respecto a la línea base pero aún no alcanza el criterio de la fase.
...
### Criterios para Ajustar el Incremento de Criterio
...
## Estrategias para Optimizar la Efectividad

### Maximizar la Motivación
...
3. **Novedad controlada**: Introducir elementos novedosos menores que mantengan interés sin alterar el protocolo fundamental.
...
### Si el Participante Rechaza Participar en una Sesión
...
### Si Ocurre una Crisis Emocional Durante la Sesión
...
4. **No continuar con la evaluación**: La prioridad es el bienestar emocional.
...
### Si los Padres Reportan Efectos Adversos
...
## Integración con el Contexto Educativo
...
3. **Uso de cronómetro en casa**: Establecer períodos de estudio de 15-20 minutos con cronómetro visible.
...
## Criterios de Éxito del Estudio
...
5. **Transferencia**: Mejoras observables en medidas de memoria de trabajo y desempeño académico.
...
## Introducción al Protocolo de Sesiones
...
## Sesión 0: Evaluación de Línea Base (semana 1)
...
### Desarrollo de la Sesión (minuto a Minuto)
...
## Sesión 1: Intervención Fase 1 - Criterio 7 Minutos (semana 2)
...
**Terapeuta:** "Ahora probá vos. Poné una mano en tu panza. Cerrá los ojos si te sentís cómodo, o dejálos abiertos si preferís."
...
**Terapeuta:** "¿Qué cosas te distrajeron? ¿Qué podríamos hacer diferente la próxima vez?"
...
## Sesión 2: Intervención Fase 2 - Criterio 10 Minutos (semana 3)
...
## Sesión 3: Intervención Fase 3 - Criterio 12 Minutos (semana 4)
...
**Terapeuta:** "Mientras vos trabajás, yo voy a tener un reloj que hace un sonido suave cada 3 minutos. Cuando escuches el sonido, te vas a preguntar estas tres cosas rapidito, y después seguís trabajando. Es solo para que te des cuenta si estás concentrado o si tu mente se fue a otro lado. ¿Se entiende?"
...
## Sesión 4: Intervención Fase 4 - Criterio 15 Minutos (semana 5)
...
**Terapeuta:** "Recordá que podés usar todas tus herramientas: cuando escuches el sonido cada 3 minutos, hacé tu checklist. Si sentís que te estás cansando, respirá profundo. ¿Listo?"
...
**Si el niño cumplió el criterio (¡15 minutos!):**
...
## Sesión 5: Post-evaluación (semana 6)
...
4. **Recomendaciones para el hogar (5 min):**
...
## Resumen de Materiales y Tiempos por Sesión

| Sesión | Duración | Actividades principales | Materiales clave |
|--------|----------|-------------------------|------------------|
...
## Consideraciones Éticas en la Implementación de Sesiones
...
**Punto de control:** Al final de la semana 2, se deben tener todas las aprobaciones éticas e institucionales, y el consentimiento/asentimiento firmados.
...
**Punto de control:** Al final de la semana 5, se debe tener el primer criterio de intervención establecido y los materiales preparados para iniciar la fase de intervención.
...
**Resultado esperado:** El niño logra 10 minutos de atención sostenida.
...
### Fase 4: Evaluación Final y Análisis (semanas 12-14)
...
## Cronograma Específico de Sesiones (semanas 4, 6, 8, 10, 11, 12)
...
**Nota:** Las fechas y horarios específicos se acordarán con la familia al inicio del estudio. Se recomienda mantener consistencia en el día y hora para controlar variables contextuales.


## Recursos Humanos y Asignación de Responsabilidades

| Rol | Responsable | Actividades principales | Dedicación estimada |
|-----|-------------|-------------------------|---------------------|
| **Investigador Principal** |  | Diseño del estudio, implementación de sesiones, análisis de datos, redacción de informe | 80 horas totales |
...
### Reforzadores para el Participante
...
**Ajuste usando recursos propios:** **$0 - $3,000**.
...
### Financiamiento Externo (opciones)
...
## Justificación de Costos Principales

### ¿por Qué Es Necesario Adquirir Reforzadores Tangibles?
...
- Aumentan la adherencia a la intervención
...
### ¿por Qué Es Necesario el Transporte del Investigador?
...
### ¿por Qué Es Necesario el Servicio de Transcripción?
...
## Aspectos Éticos del Presupuesto
...
## Cronograma Financiero Vs. Cronograma de Actividades
...
## Indicadores de Eficiencia del Presupuesto
...
**Información incluida en el consentimiento:**
...
### Manejo de Grabaciones de Audio/video
...
| Tipo de Riesgo | Nivel | Descripción | Medidas de Mitigación |
|----------------|-------|-------------|------------------------|
...
### Criterios de Retiro por Parte del Investigador
...
## Responsabilidad y Competencia del Investigador
...
### Devolución a la Institución Educativa
...
Se realizará una **sesión de cierre con el niño** donde:
...
### Acceso de los Participantes a las Publicaciones
...
## Aspectos Éticos Específicos del Diseño N=1
...
### Sensibilidad a Necesidades Especiales
...
## Plan de Contingencia Ante Situaciones Éticas Emergentes

### Comité de Ética de Respuesta Rápida
...
El investigador principal declara que:
...
## Análisis Visual de Series Temporales
...
### Construcción del Gráfico de Series Temporales
...
### Criterios de Análisis Visual (parsonson & Baer, 1978)
...
#### **inmediatez del Efecto (immediacy Of Effect)**
...
#### **consistencia de los Datos Entre Fases Similares (consistency)**
...
### Decisión Basada en Análisis Visual
...
## Análisis Estadístico: Índices de No Solapamiento
...
### Porcentaje de Datos No Solapantes (pnd - Percentage Of Non-overlapping Data)
...
### Porcentaje de Todos los Datos No Solapantes (pand)
...
### No Solapamiento de Todos los Pares (nap - Nonoverlap Of All Pairs)
...
## Análisis Pre-post de Variables Cuantitativas
...
### Análisis de Observaciones Conductuales
...
## Integración de Resultados: Triangulación de Datos
...
## Criterios de Éxito de la Intervención
...
## Cronograma de Análisis de Datos
...
### Estructura de la Sección "resultados" del Informe
...
### Limitaciones Inherentes al Diseño N=1
...
## Consideraciones Éticas del Análisis de Datos
...
## Resultados Esperados en la Variable Principal: Atención Sostenida
...
## Resultados Esperados en Variables Secundarias

### Hipótesis Específica 2: Memoria de Trabajo
...
### Hipótesis Específica 3: Rendimiento Académico
...
- **Datos cualitativos (observaciones docentes):** "Puede completar actividades de 10-15 minutos sin levantarse", "Sigue mejor las instrucciones en clase".
- **Datos cuantitativos (Aritmética):** Mejora de 1-2 puntos en el puntaje bruto.

### Hipótesis Específica 4: Regulación Emocional
...
### Hipótesis Específica 5: Motivación Académica
...
## Resultados Esperados en Generalización de Estrategias

### Uso de Técnicas de Psicohigiene en Contextos Naturales
...
## Resultados Esperados en el Análisis Estadístico

### Índices de No Solapamiento
...
## Resultados Esperados en Variables Cualitativas

### Percepción de Cambio del Participante
...
### Percepción de Cambio de los Padres

**Resultado esperado:**

Los padres reportarán mejoras observables en:

- Atención sostenida durante tareas escolares
...
## Resultados Esperados en Relación a los Objetivos del Estudio
...
| **OE10:** Documentar percepciones del niño y familia | Entrevistas reflejan percepción de mejora | ✓ Cumplido |
...
## Resultados Esperados en Mantenimiento del Efecto

### Post-evaluación Inmediata (sesión 5)
...
### Seguimiento a 1 Mes (post-proyecto)
...
### Escenario Óptimo (resultados Superiores a Lo Esperado)
...
### Escenario Realista (resultados Esperados)
...
### Escenario Subóptimo (resultados Parciales)
...
### Impacto para la Institución Educativa
...
### Impacto para la Ciencia Psicológica
...
### Características Específicas del Participante
...
- La **aceptabilidad y efectividad** de las técnicas de psicohigiene (respiración, relajación) pueden variar según el contexto cultural.
...
### Ausencia de Intervención en Múltiples Contextos (escuela y Hogar)
...
- **Nivel de estrés académico:** Si se realiza en período de evaluaciones finales, el niño puede estar más estresado.
...
- Entrevistas semi-estructuradas (auto-reporte del niño y padres).
...
### Ausencia de Intervención con Grupo Control
...
## Estrategias Generales para Abordar las Limitaciones
...
Las limitaciones identificadas en este apartado **no invalidan el estudio**, sino que:
...
# Aportes y Relevancia del Estudio
...
### Contribución a la Comprensión del Tda
...
### Evidencia sobre Mecanismos de Cambio

**Aporte:**

El estudio permite identificar **mecanismos específicos de cambio**:

- **Reforzamiento contingente** → Aumento de frecuencia de la conducta de atención sostenida.
...
### Validación del Diseño de Caso Único en Contexto Argentino
...
### Protocolo Detallado y Replicable
...
El estudio utiliza **triangulación de métodos**:
...
### Herramientas Transferibles para Profesionales
...
- Efectividad de intervenciones en el sistema educativo público argentino.
...
### Reducción de Medicalización Innecesaria
...
## Potencial de Diseminación y Escalabilidad

### Publicaciones Científicas

**Potencial:**

Los resultados del estudio pueden ser publicados en:
...
- **Transferencia de conocimiento** de la academia a la práctica profesional.
- **Democratización del acceso** a intervenciones basadas en evidencia.


## Líneas de Investigación Futuras Generadas

Este estudio abre múltiples **líneas de investigación futuras**:

### Replicación con Diferentes Poblaciones
...
### Variaciones de la Intervención
...
### Estudios de Mediadores y Moderadores
...
## Relevancia en el Contexto de la Pandemia y Post-pandemia Covid-19

**Aporte especialmente relevante:**
...
## Conclusión: Síntesis de la Relevancia del Estudio
...
Koppitz, E. M. (1974). *El Test Guestáltico Visomotor de Bender para niños.* Guadalupe.
...
National Institute of Mental Health (NIMH). (2022). *Attention-Deficit/Hyperactivity Disorder.* https://www.nimh.nih.gov/health/topics/attention-deficit-hyperactivity-disorder-adhd
...
## Lecturas Recomendadas para Profundización

Para lectores interesados en profundizar en los temas del estudio, se recomiendan especialmente las siguientes obras:
...
## Declaración de Integridad Bibliográfica
...
**Importante:** Si en algún momento su hijo/a muestra malestar significativo o desea detenerse, la sesión se interrumpirá inmediatamente.
...
Vamos a vernos **6 veces** durante varias semanas. En cada encuentro vamos a:
...
### Técnicas de Psicohigiene (si Aplica)
...
### Observaciones Conductuales Cualitativas
...
**Análisis del desempeño en esta sesión:**
_________________________________________________________________
_________________________________________________________________
...
**Total de estrellas (★) en esta hoja:** 79
...
"¿Hay algo que piensan que podría mejorarse en este tipo de intervenciones?"
...
**De:** , Licenciado/a en Psicología (en formación)
**Fecha:** ___/___/______
...
**Capacidad Intelectual (Test de Raven):**
...
**Grado:** 3º año
**Fecha:** ___/___/______
**Elaborado por:** , Lic. en Psicología (en formación)
**Institución:** [Universidad]
...
**1. Permitir el uso de técnicas de respiración:**
...
1. **Asegurar el cumplimiento ético** (consentimiento, asentimiento, confidencialidad).
